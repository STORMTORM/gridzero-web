...
export default function DesignSidebar({
	...
	if (currentStage !== 2) {
		return (
			<div className="w-full md:w-[380px] bg-neutral-900/60 p-6 flex flex-col justify-between flex-shrink-0 border-l border-white/10 gap-6 overflow-y-auto z-20">
				<div>
					...
					<p className="text-[11px] text-neutral-500 font-medium mt-1">
						Options for this design step are coming soon.
					</p>
				</div>
			</div>
		);
					...
					{!isDrawing ? (
						...
						<div className="flex-1 flex gap-2">
							...
							<button
								...
								className="flex-1 py-2.5 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 text-xs font-bold rounded-xl border border-rose-500/15 transition-all cursor-pointer"
							>
								Cancel
							</button>
						</div>
					...
					<div className="border-t border-white/10 pt-5 flex flex-col gap-5 bg-transparent animate-in slide-in-from-bottom duration-250">
						<div className="flex justify-between items-center">
							...
							<button
								...
								className="p-1 hover:bg-rose-500/10 text-neutral-500 hover:text-rose-400 rounded-lg transition-colors cursor-pointer"
