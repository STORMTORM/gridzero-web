...
import type { PlacedPanelGroup, PlacementConfig, RoofData } from "../types";
import type { SceneData, PanelSpec, PanelGroup, LocalObject } from "../../../utils/design/types";
import { designApi } from "../api/designApi";
import { panelService } from "../services/panelService";
import { DEFAULT_PLACEMENT_CONFIG } from "../constants";
...
export function usePanelPlacement({
	...
	}, [panelGroups, selectedGroupId, targetPanelCount, placedPanelCount, panelSpec, roofs, objects, setToastMessage, savePanelsDesignDebounced]);
	...
	}, [panelGroups, selectedGroupId, setSelectedGroupId, savePanelsDesign]);
